  ...
  return (
    <Layout usuario={usuario}>
      <div style={{ padding: '28px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {/* Abas */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '12px', marginBottom: '24px', borderBottom: '2px solid #e2e8f0', paddingBottom: '8px', width: '100%' }}>
          <button 
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: 'none', border: 'none', fontSize: '14px', fontWeight: '700', cursor: 'pointer', color: aba === 'importacao' ? corPerfil : '#64748b', borderBottom: aba === 'importacao' ? `3px solid ${corPerfil}` : '3px solid transparent', paddingBottom: '10px', marginBottom: '-10px', fontFamily: 'Sora, sans-serif', whiteSpace: 'nowrap', width: '100%' }}
            onClick={() => router.replace('/bpa', { scroll: false })}
          >
            <Upload size={14} />Nova Importação
          </button>
          <button
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: 'none', border: 'none', fontSize: '14px', fontWeight: '700', cursor: 'pointer', color: aba === 'historico' ? corPerfil : '#64748b', borderBottom: aba === 'historico' ? `3px solid ${corPerfil}` : '3px solid transparent', paddingBottom: '10px', marginBottom: '-10px', fontFamily: 'Sora, sans-serif', whiteSpace: 'nowrap', width: '100%' }}
            onClick={() => router.replace('/bpa?tab=historico', { scroll: false })}
          >
            <BarChart2 size={14} /> Relatório Histórico
          </button>
          <button
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: 'none', border: 'none', fontSize: '14px', fontWeight: '700', cursor: 'pointer', color: aba === 'apac' ? '#10b981' : '#64748b', borderBottom: aba === 'apac' ? `3px solid #10b981` : '3px solid transparent', paddingBottom: '10px', marginBottom: '-10px', fontFamily: 'Sora, sans-serif', whiteSpace: 'nowrap', width: '100%' }}
            onClick={() => router.replace('/bpa?tab=apac', { scroll: false })}
          >
            <FileText size={14} /> Laudo APAC
          </button>
          <button
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: 'none', border: 'none', fontSize: '14px', fontWeight: '700', cursor: 'pointer', color: aba === 'encaminhamento' ? '#3b82f6' : '#64748b', borderBottom: aba === 'encaminhamento' ? `3px solid #3b82f6` : '3px solid transparent', paddingBottom: '10px', marginBottom: '-10px', fontFamily: 'Sora, sans-serif', whiteSpace: 'nowrap', width: '100%' }}
            onClick={() => router.replace('/bpa?tab=encaminhamento', { scroll: false })}
          >
            <FileText size={14} /> Encaminhamento
          </button>
          <button
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: 'none', border: 'none', fontSize: '14px', fontWeight: '700', cursor: 'pointer', color: aba === 'citopatologico' ? '#10b981' : '#64748b', borderBottom: aba === 'citopatologico' ? `3px solid #10b981` : '3px solid transparent', paddingBottom: '10px', marginBottom: '-10px', fontFamily: 'Sora, sans-serif', whiteSpace: 'nowrap', width: '100%' }}
